...
public final class Utility {
    static void addScreenshotToLog(WebDriver driver) throws IOException {
    ...
    static void hideElement(WebDriver driver, WebElement webElement) throws IOException {
    ...
    static int getNumbersFromText(String text) {
        int numbers;
